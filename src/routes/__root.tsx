...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "MONO/STR — Modern Streetwear Studio" },
      { name: "twitter:description", content: "Editorial streetwear. Hoodies, longsleeves and shirts crafted in limited drops." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/67e1755b-95f1-4de8-b7f9-2be61eecc0a8/id-preview-3b719755--2eb5fcf3-8156-4081-a1e3-e36618848d3f.lovable.app-1778175639643.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/67e1755b-95f1-4de8-b7f9-2be61eecc0a8/id-preview-3b719755--2eb5fcf3-8156-4081-a1e3-e36618848d3f.lovable.app-1778175639643.png" },
    ],
